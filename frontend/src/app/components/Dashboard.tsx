...
export function Dashboard() {
  ...
  const mappedData: CandidateRecord[] = data.map((c, index) => ({
    id: index.toString(),
    name: c.filename,
    email: "N/A",
    score: c.score,
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-foreground min-w-[45px]">
                          {candidate.score}%
                        </span>
                    ...
                    <td className="px-6 py-4">
                      ...
                      <span
                        className={`px-3 py-1 rounded-full text-xs capitalize ${getStatusColor(candidate.status)}`}
                      >
                        {candidate.status}
                      </span>
